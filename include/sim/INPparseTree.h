...
/* RCS Info: $Revision: 1.1 $ on $Date: 91/04/02 11:26:10 $
 *           $Source: //pepper/atesse_spice/spice3/include/RCS/INPparseTree.h,v $
...
#ifdef __STDC__
extern int IFeval(IFparseTree *, double*, double*, double*);
#else /* stdc */
extern int IFeval();
#endif /* stdc */

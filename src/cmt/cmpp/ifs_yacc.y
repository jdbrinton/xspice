%{ /* $Id: ifs_yacc.y,v 1.17 91/12/31 15:29:28 bill Exp $ */
...
string			: TOK_STRING_LITERAL {$$ = strdup(yytext);}
			;

identifier		: TOK_IDENTIFIER {$$ = strdup(yytext);}
			;

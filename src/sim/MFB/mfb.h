 ...
 * mfb.h
 *
 * Copyright -C- 1982 Giles C. Billingsley, Kenneth H. Keller
...
#ifndef DEFAULTMFBCAP

#ifdef vms
#define DEFAULTMFBCAP "UMA0:[CAD.LIB]MFBCAP."   /* default VMS mfbcap file */
#else
#define DEFAULTMFBCAP "~cad/lib/mfbcap"     /* default UNIX mfbcap file */
#endif
...
extern int MFBsaveflg;          /* kludgy ungetc */

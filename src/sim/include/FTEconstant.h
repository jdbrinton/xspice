...
/* RCS Info: $Revision: 1.1 $ on $Date: 91/04/02 11:25:40 $
 *         $Source: //pepper/atesse_spice/spice3/include/RCS/FTEconstant.h,v $
 * Copyright (c) 1985 Wayne A. Christopher, U. C. Berkeley CAD Group
 *
 * Some spice constants.
 */
...
typedef enum {
    ...
    GRID_YLOG = 4, GRID_POLAR = 5, GRID_SMITH = 6,
} GRIDTYPE;

 ...
 *           $Source: //pepper/atesse_spice/spice3/CP/RCS/front.c,v $
 * Copyright (c) 1985 Wayne A. Christopher, U. C. Berkeley CAD Group
 *
 * The front-end command loop.  There are some tricky things that we have to
 * do here...
 */
...
#define newblock    cend[stackp]->co_children = alloc(control);      \

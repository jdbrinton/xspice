...
/* RCS Info: $Revision: 1.1 $ on $Date: 91/04/02 12:04:25 $
 *           $Source: //pepper/atesse_spice/spice3/CP/RCS/spawn.c,v $
 *
...
/* gtri - modify - wbk - 11/9/90 - Make ducks routine global */
/* because it bombs otherwise.  Change name to xxx_ducks_xxx also */

int xxx_ducks_xxx() { return (0); }

...
RCSID("INPpas2.c $Revision: 1.1 $ on $Date: 91/04/02 11:57:11 $")

    /* pass 2 - pass through the card images built up so far and
     *  perform the appropriate actions.  We have pre-read all of
     *  the .MODEL cards, so we can ignore them
     */

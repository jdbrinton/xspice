...
/* RCS Info: $Revision: 1.2 $ on $Date: 91/06/27 20:27:21 $
 *           $Source: //pepper/atesse_spice/spice3/FTE/RCS/cmdtab.c,v $
...
static void dummy() { fprintf(cp_err, "Gasp\n"); exit(EXIT_BAD); }
...
#ifdef MENU
#ifdef GI_X
    { "clearplot", com_clearplot, false, false, false,
      { 0, 0, 0, 0}, E_BEGINNING | E_MENUMODE | E_HASGRAPHS, 0, LOTS,
      (int (*)()) NULL,
      ": Clears all the plots on the screen." } ,
#endif
#endif
...
/* gtri - end - wbk - add event print command */
    ...
    { "sens", com_sens, false, true, true,
      { 0, 0, 0, 0 }, E_DEFHMASK, 0, LOTS,
      (int (*)()) NULL,
      "[.ac card args] : Do a sensitivity analysis." } ,
    ...
    { "while", dummy, false, false, false,
      { 040000, 040000, 040000, 040000 }, E_DEFHMASK, 1, LOTS,
      (int (*)()) NULL,
      "condition : Execute while the condition is true." } ,
    { "repeat", dummy, false, false, false,
      { 0, 0, 0, 0}, E_DEFHMASK, 0, 1,
      (int (*)()) NULL,
      "[number] : Repeat number times, or forever." } ,
    { "dowhile", dummy, false, false, false,
      { 040000, 040000, 040000, 040000 }, E_DEFHMASK, 1, LOTS,
      (int (*)()) NULL,
      "condition : Execute while the condition is true." } ,
    { "foreach", dummy, false, false, false,
      { 0, 040000, 040000, 040000 }, E_DEFHMASK, 2, LOTS,
      (int (*)()) NULL,
      "variable value ... : Do once for each value." } ,
    { "if", dummy, false, false, false,
      { 040000, 040000, 040000, 040000 }, E_DEFHMASK, 1, LOTS,
      (int (*)()) NULL,
      "condition : Execute if the condition is true." } ,
    { "else", dummy, false, false, false,
      { 0, 0, 0, 0 }, E_DEFHMASK, 0, 0,
      (int (*)()) NULL,
      ": Goes with if." } ,
    { "end", dummy, false, false, false,
      { 0, 0, 0, 0 }, E_DEFHMASK, 0, 0,
      (int (*)()) NULL,
      ": End a block." } ,
    { "break", dummy, false, false, false,
      { 0, 0, 0, 0 }, E_DEFHMASK, 0, 0,
      (int (*)()) NULL,
      ": Break out of a block." } ,
    { "continue", dummy, false, false, false,
      { 0, 0, 0, 0 }, E_DEFHMASK, 0, 0,
      (int (*)()) NULL,
      ": Continue a loop." } ,
    { "label", dummy, false, false, false,
      { 0, 0, 0, 0 }, E_DEFHMASK, 1, 1,
      (int (*)()) NULL,
      "word : Create someplace to go to." } ,
    { "goto", dummy, false, false, false,
    ...
    { "", NULL, false, false, false, { 0, 0, 0, 0 }, E_DEFHMASK, 0, LOTS,
      (int (*)()) NULL,
      NULL }

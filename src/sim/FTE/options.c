...
/* RCS Info: $Revision: 1.1 $ on $Date: 91/04/02 12:12:02 $
 *           $Source: //pepper/atesse_spice/spice3/FTE/RCS/options.c,v $
...
/* Debugging variables for everything... */
    ...
    bool isset;
{
...
#else
        fprintf(cp_err, "Warning: unixcom works only with BSD UNIX.\n");
#endif
    ...
    */
    ...
    if (ft_curckt)
        if_option(ft_curckt->ci_ckt, var->va_name, var->va_type, vv);
    return (US_OK);
}
